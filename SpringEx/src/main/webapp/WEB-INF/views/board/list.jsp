...
--------------------------------------------------------------------------------------------------------------------------------------
 	<table border=1>
 		<tr>
 			<td>게시판 번호</td><td>제목</td><td>내용</td><td>작성일자</td><td>조회수</td>
 		</tr>
 		<!-- for문 시작 -->
	...
	<c:if test="${paging.next}">
		...
		<a href="/board/write">글쓰기</a>                  <a href="/">메인화면으로</a>
