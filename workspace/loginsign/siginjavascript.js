window.onload = function () {
  ...
  userpassword.onblur = function () {
    ...
    if(userpassowrdValue == ""){
      pwmsg.innerHTML = "빈칸으로 둘 수 없습니다.";
      pwmsg.style.color = "red";
      pwmsg.style.fontSize = "13px";
      return false;
      }
  ...
  useremail.onblur = function () {
    ...
    if (regEmail.test(useremailValue)) {
      ...
      if(useremailValue == ""){
      emailmsg.innerHTML = "빈칸으로 둘 수 없습니다.";
      emailmsg.style.color = "red";
      emailmsg.style.fontSize = "13px";
      return false;
    	}
  ...
  userpassword2.onblur = function () {
    ...
    if (userpassword2Value === userpasswordValue) {
      ...
      pwmsg2.style.fontSize = "13px";
    	...
    	if(userpassowrd2Value == ""){
        pwmsg2.innerHTML = "빈칸으로 둘 수 없습니다.";
        pwmsg2.style.color = "red";
        pwmsg2.style.fontSize = "13px";
    }
  }
