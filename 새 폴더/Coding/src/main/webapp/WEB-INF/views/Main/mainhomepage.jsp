...
<body>
  <div class="header">
    <div class="navbar">
      ...
      <div class="navbar_loginsignin">
        <ul>
          <li id="li"><a href="main/login">로그인</a></li>
          <li id="li"><a href="main/signin">회원가입</a></li>
        </ul>
      </div>
  ...
  <div class="section">
    ...
    <div class="slidewrap">
      <ul class="slidelist">
        <li>
          <label for="slide03" class="left"><img src="../배너 화살표.png" class="L_img"></label>
          <a href="https://tomcat.apache.org/">
            <img class="banner" src="../tomcat.png" style="border-style:none;" alt="광고"></a>
          </a>
          <label for="slide02" class="right"><img src="../배너 화살표 - 복사본.png" class="R_img"></label>
        </li>
        <li>
          <label for="slide01" class="left"><img src="../배너 화살표.png" class="L_img"></label>
          <a href="https://www.w3schools.com/">
            <img class="banner" src="../w3schools.jpg" style="border-style:none;" alt="광고">
          </a>
          <label for="slide03" class="right"><img src="../배너 화살표 - 복사본.png" class="R_img"></label>
        </li>
        <li>
          <label for="slide02" class="left"><img src="../배너 화살표.png" class="L_img"></label>
          <a href="https://www.acmicpc.net/">
            <img class="banner" src="../백준.png" style="border-style:none;" alt="광고">
          </a>
          <label for="slide01" class="right"><img src="../배너 화살표 - 복사본.png" class="R_img"></label>
        </li>
  ...
  <div id="container">
        ...
        <div class="tabcontent">
          ...
          <div id="tab02">
            <table id="calendar">
              <thead>
                <tr>
                  <th><input class="monthbutton" name="preMon" type="image" src="../next - 복사본.png"></th>
                  <th colspan="5" class="year_mon"></th>
                  <th><input class="monthbutton" name="nextMon" type="image" src="../next.png"></th>
                </tr>
                <tr>
      ...
      <div class="list">
        ...
        <div class="user">
          ...
          <div class="profile-box">
            ...
            <a href="#">
              <img class="profile" src="../다운로드.jpg">
            </a>
          </div>
    ...
    <div id="rightbox">
      ...
      <div class="card">
        <div class="card_head">
          <input class="titlelogo" type="image" src="../pen.png">
          <div>
            <a href="#">
      ...
      <div class="card">
        <div class="card_head">
          <input class="titlelogo" type="image" src="../lamp.png">
          <div>
            <a href="#">
      ...
      <div class="card">
        <div class="card_head">
          <input class="titlelogo" type="image" src="../Q&A로고.png">
          <div>
            <a href="#">
      ...
      <div class="googlebox">
        ...
        <button class="googlebutton"><img src="../Google__G__Logo.svg.png" class="googlebutton_img"></button>
